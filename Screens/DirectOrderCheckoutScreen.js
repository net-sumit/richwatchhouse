...
const DirectOrderCheckout = ({ route, navigation }) => {
    console.log(route.params.user_id, 'user_id');
    ...
    useEffect(() => {
        const asyncPostCall = async () => {
            try {
                const response = await fetch(countryListDataApi, {
                    method: 'POST',
                    headers: {
                ...
                console.log(data.data, 'Country listing');
                var objCountryData = [];
...
export default DirectOrderCheckout